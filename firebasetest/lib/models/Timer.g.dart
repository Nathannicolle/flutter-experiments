...
class _$TimerDocumentReference
  ...
  Future<void> update({
    ...
    final json = {
      ...
      if (duee != _sentinel) "duee": duee as int,
...
class _$TimerQuery extends QueryReference<TimerQuerySnapshot>
  ...
  TimerQuery orderByDuee({
    ...
    var query = reference.orderBy('duee', descending: descending);
